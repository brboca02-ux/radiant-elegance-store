...
const seed: Product[] = [
  ...
  {
    id: "p_035", store_id: STORE_ID, name: "Conjunto Tricô Listrado Preto e Branco", slug: "conjunto-trico-listrado-pb",
    description: "Conjunto de tricô em listras preto e branco: cropped regata e calça pantalona. Look estiloso e moderno.",
    category_id: "conjuntos", brand: "MD Modas", sku: "CJT-TRC-LST",
    price: 259.9, sale_price: 219.9, stock: 6, weight: 0.5, status: "ativo",
    ...baseProduct,
    meta_title: "Conjunto Tricô Listrado P&B — MD Modas", meta_description: "Conjunto tricô listrado preto e branco.",
    images: [mkImg("p_035", "/__l5e/assets-v1/16f51f5e-3307-474a-9e6d-72f3e2e8fdf1/conjunto-trico-listrado-pb.jpg", 0, true)],
    variants: [
      { id: uid(), product_id: "p_035", size: "P", color: "Preto/Branco", stock: 2 },
      { id: uid(), product_id: "p_035", size: "M", color: "Preto/Branco", stock: 2 },
      { id: uid(), product_id: "p_035", size: "G", color: "Preto/Branco", stock: 2 },
    ],
    created_at: new Date(Date.now() - 86400000 * 1).toISOString(),
  },
  {
    id: "p_036", store_id: STORE_ID, name: "Camisa Listrada Laço Preta", slug: "camisa-listrada-laco-preta",
    description: "Camisa social preta com listras finas brancas e gola laço. Manga longa com punho franzido. Toque sedoso.",
    category_id: "blusas", brand: "MD Modas", sku: "BLU-CAM-LAC",
    price: 159.9, sale_price: 129.9, stock: 8, weight: 0.25, status: "ativo",
    ...baseProduct,
    meta_title: "Camisa Listrada Laço — MD Modas", meta_description: "Camisa social preta listrada com laço.",
    images: [mkImg("p_036", "/__l5e/assets-v1/2ffd1405-9092-4d3c-a7c0-1e31f7c8aa13/camisa-listrada-laco.jpg", 0, true)],
    variants: [
      { id: uid(), product_id: "p_036", size: "P", color: "Preto/Branco", stock: 3 },
      { id: uid(), product_id: "p_036", size: "M", color: "Preto/Branco", stock: 3 },
      { id: uid(), product_id: "p_036", size: "G", color: "Preto/Branco", stock: 2 },
    ],
    created_at: new Date(Date.now() - 86400000 * 2).toISOString(),
  },
  {
    id: "p_037", store_id: STORE_ID, name: "Calça Jogger Esportiva", slug: "calca-jogger-esportiva",
    description: "Calça jogger masculina em moletom premium com cordão e punho. Disponível em preto, cinza mescla (Lacoste) e azul marinho (Nike).",
    category_id: "masculino", brand: "Multimarcas", sku: "CAL-JOG-ESP",
    price: 219.9, sale_price: 179.9, stock: 12, weight: 0.5, status: "ativo",
    ...baseProduct,
    meta_title: "Calça Jogger Esportiva — MD Modas", meta_description: "Calça jogger esportiva premium em 3 cores.",
    images: [mkImg("p_037", "/__l5e/assets-v1/36e5ed97-6a58-4e6a-8986-7f5bda0e1116/calcas-jogger-esportivas.jpg", 0, true)],
    variants: [
      { id: uid(), product_id: "p_037", size: "M", color: "Preto", stock: 4 },
      { id: uid(), product_id: "p_037", size: "G", color: "Cinza Mescla", stock: 4 },
      { id: uid(), product_id: "p_037", size: "GG", color: "Azul Marinho", stock: 4 },
    ],
    created_at: new Date(Date.now() - 86400000 * 3).toISOString(),
  },
  {
    id: "p_038", store_id: STORE_ID, name: "T-Shirt Cropped Suspensório Grafite", slug: "tshirt-cropped-suspensorio-grafite",
    description: "T-shirt cropped grafite com detalhe de suspensório e botões em madeira no ombro. Decote V e modelagem oversized.",
    category_id: "blusas", brand: "MD Modas", sku: "BLU-CRP-SUS",
    price: 99.9, sale_price: 79.9, stock: 10, weight: 0.2, status: "ativo",
    ...baseProduct,
    meta_title: "T-Shirt Cropped Suspensório — MD Modas", meta_description: "Cropped grafite com detalhe suspensório.",
    images: [mkImg("p_038", "/__l5e/assets-v1/9506c69e-be68-4974-aa50-0e341e087860/tshirt-cropped-grafite.jpg", 0, true)],
    variants: [
      { id: uid(), product_id: "p_038", size: "P", color: "Grafite", stock: 3 },
      { id: uid(), product_id: "p_038", size: "M", color: "Grafite", stock: 4 },
      { id: uid(), product_id: "p_038", size: "G", color: "Grafite", stock: 3 },
    ],
    created_at: new Date(Date.now() - 86400000 * 4).toISOString(),
  },
  {
    id: "p_039", store_id: STORE_ID, name: "Cropped Tricô Caramelo Vazado", slug: "cropped-trico-caramelo-vazado",
    description: "Cropped corselet em tricô caramelo com pontos vazados, alças largas e modelagem que valoriza o busto.",
    category_id: "blusas", brand: "MD Modas", sku: "BLU-CRP-VAZ",
    price: 129.9, sale_price: 99.9, stock: 7, weight: 0.15, status: "ativo",
    ...baseProduct,
    meta_title: "Cropped Tricô Vazado — MD Modas", meta_description: "Cropped corselet tricô caramelo vazado.",
    images: [mkImg("p_039", "/__l5e/assets-v1/ab00ffdc-098c-4643-bc10-9ddf413ec410/cropped-trico-caramelo.jpg", 0, true)],
    variants: [
      { id: uid(), product_id: "p_039", size: "P", color: "Caramelo", stock: 3 },
      { id: uid(), product_id: "p_039", size: "M", color: "Caramelo", stock: 2 },
      { id: uid(), product_id: "p_039", size: "G", color: "Caramelo", stock: 2 },
    ],
    created_at: new Date(Date.now() - 86400000 * 5).toISOString(),
  },
  {
    id: "p_040", store_id: STORE_ID, name: "T-Shirt Cropped Wild West Country", slug: "tshirt-wild-west-country",
    description: "T-shirt cropped branca com estampa Wild West Country e botas cowboy em glitter marrom. Estilo country chic.",
    category_id: "blusas", brand: "MD Modas", sku: "BLU-CRP-CWB",
    price: 89.9, sale_price: 69.9, stock: 14, weight: 0.18, status: "ativo",
    ...baseProduct,
    meta_title: "Cropped Wild West Country — MD Modas", meta_description: "Cropped branco estampa Wild West Country.",
    images: [mkImg("p_040", "/__l5e/assets-v1/054f8b33-6283-4483-a443-814c52fe78ef/tshirt-wild-west.jpg", 0, true)],
    variants: [
      { id: uid(), product_id: "p_040", size: "P", color: "Branco", stock: 5 },
      { id: uid(), product_id: "p_040", size: "M", color: "Branco", stock: 5 },
      { id: uid(), product_id: "p_040", size: "G", color: "Branco", stock: 4 },
    ],
    created_at: new Date(Date.now() - 86400000 * 6).toISOString(),
  },
];
