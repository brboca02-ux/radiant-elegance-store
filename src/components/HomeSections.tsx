  ...
  return (
    <section className="section-compact bg-background">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        <ProductGrid sortKey="BEST_SELLING" first={8} columns={{ mobile: 2, tablet: 3, lg: 4, desktop: 5 }} />
      </div>
    </section>
  );
}
  ...
  return (
    <section id="colecao" className="section-compact bg-background">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        <ProductGrid sortKey="CREATED_AT" reverse first={8} columns={{ mobile: 2, tablet: 3, lg: 4, desktop: 5 }} />
      </div>
    </section>
  );
}
