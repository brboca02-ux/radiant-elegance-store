  ...
  return (
    <section className="section-compact bg-background">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        <ProductGrid sortKey="CREATED_AT" reverse first={5} columns={{ mobile: 2, tablet: 3, desktop: 5 }} excludeShowcase />
      </div>
    </section>
  );
}
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="space-y-5 order-1 md:order-2">
          ...
          <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
            ...
            <p className="flex items-start gap-2"><Clock className="h-4 w-4 mt-0.5 text-foreground shrink-0" /> Seg a Sex: 8h–22h · Sáb e Dom: 8h–20h</p>
