...
export function HomeHero() {
  return (
    <section className="relative h-[50vh] min-h-[360px] md:h-[65vh] md:min-h-[460px] lg:h-[82vh] lg:min-h-[640px] overflow-hidden bg-onyx">
      <img
        src={heroCouple.url}
        ...
        height={768}
        fetchPriority="high"
        className="absolute inset-0 w-full h-full object-cover object-[left_center] lg:object-center"
      />
